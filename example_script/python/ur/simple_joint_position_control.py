    ...
    try:
        ...
        start_joint_trajectory_msg = {
            ...
            'points': [{
                ...
                'time_from_start': {'secs': 0, 'nsecs': 0}  # Time for reaching the desired position
            }]
        }
        ...
        topic = roslibpy.Topic(client, '/follow_joint_trajectory/goal', 'control_msgs/FollowJointTrajectoryAction')
        topic.advertise()
